...
#define BLIT_COLLISION_GRID_EXTENT															5000u
#define BLIT_COLLISION_GRID_CELL_EXTENT														100u
...
#endif
#define BLIT_COLLISION_GRID_CELL_COUNT														(BLIT_COLLISION_GRID_CELL_FLAT_COUNT * BLIT_COLLISION_GRID_CELL_FLAT_COUNT * BLIT_COLLISION_GRID_CELL_FLAT_COUNT)
#ifdef __cplusplus
	static_assert(BLIT_COLLISION_GRID_CELL_COUNT == BLIT_COLLISION_GRID_CELL_FLAT_COUNT * BLIT_COLLISION_GRID_CELL_FLAT_COUNT * BLIT_COLLISION_GRID_CELL_FLAT_COUNT);
#endif
#define BLIT_COLLIDER_COUNT_PER_GRID_CELL													(BLIT_COLLISION_GRID_CELL_EXTENT / 0.5f)
#define BLIT_AVAILABLE_COLLIDER_SPACES														(BLIT_COLLIDER_COUNT_PER_GRID_CELL * BLIT_COLLISION_GRID_CELL_COUNT)
#ifdef __cplusplus
	static_assert(BLIT_COLLIDER_COUNT_PER_GRID_CELL == BLIT_COLLISION_GRID_CELL_EXTENT / 0.5f);
	static_assert(BLIT_AVAILABLE_COLLIDER_SPACES == (BLIT_COLLIDER_COUNT_PER_GRID_CELL * BLIT_COLLISION_GRID_CELL_COUNT));
#endif
#define BLIT_DYNAMIC_COLLIDER_COUNT_PER_GRID_CELL											(BLIT_COLLISION_GRID_CELL_EXTENT / 0.5f)
#define BLIT_AVAILABLE_DYNAMIC_COLLIDER_SPACES												(BLIT_DYNAMIC_COLLIDER_COUNT_PER_GRID_CELL * BLIT_COLLISION_GRID_CELL_COUNT)
#ifdef __cplusplus
		static_assert(BLIT_DYNAMIC_COLLIDER_COUNT_PER_GRID_CELL == BLIT_COLLISION_GRID_CELL_EXTENT / 0.5f);
