...
*************************************************************************************************************************************************/
	...
	constexpr uint BLIT_HLSL_CPU_TRANSFORM_BUFFER_REGISTER = 14;
	...
	constexpr uint BLIT_HLSL_LAST_FRAME_EULER_REGISTER = 3;// UNUSED, Can be replaced when a new srv comes
