...
#define BLIT_RESIDENT_MOVEMENT_NONE							(BLIT_RESIDENT_MOVEMENT_FLAG_BITS)0x0
#define BLIT_RESIDENT_MOVEMENT_ROTATING_YAW_BIT				(BLIT_RESIDENT_MOVEMENT_FLAG_BITS)0x1
#define BLIT_RESIDENT_MOVEMENT_ROTATING_PITCH_BIT			(BLIT_RESIDENT_MOVEMENT_FLAG_BITS)0x2
#define BLIT_RESIDENT_MOVEMENT_ROTATING_ROLL_BIT			(BLIT_RESIDENT_MOVEMENT_FLAG_BITS)0x4