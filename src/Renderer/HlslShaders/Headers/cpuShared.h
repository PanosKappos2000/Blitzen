...
typedef uint BLIT_RESIDENT_MOVEMENT_FLAG_BITS;

#define BLIT_RESIDENT_MOVEMENT_NONE							(BLIT_RESIDENT_MOVEMENT_FLAG_BITS)0x0u
#define BLIT_RESIDENT_MOVEMENT_ROTATING_YAW_BIT				(BLIT_RESIDENT_MOVEMENT_FLAG_BITS)0x5u
#define BLIT_RESIDENT_MOVEMENT_ROTATING_PITCH_BIT			(BLIT_RESIDENT_MOVEMENT_FLAG_BITS)0xAu
#define BLIT_RESIDENT_MOVEMENT_ROTATING_ROLL_BIT			(BLIT_RESIDENT_MOVEMENT_FLAG_BITS)0xFu