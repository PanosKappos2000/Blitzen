...
#define BLIT_MAX_DRAW_COMMANDS																500000u
#ifdef __cplusplus
	static_assert(BLIT_MAX_DRAW_COMMANDS > BLIT_OPAQUE_STATIC_RENDER_OFFSET);
#endif
...
*************************************************************************************************************************************************/
	...
	constexpr uint BLIT_HLSL_TEXTURE_DESCRIPTORS_REGISTER = 15;
